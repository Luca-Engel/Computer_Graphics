...
void main() {
    ...
    */
	...
	vec3 v2f_dir_to_light = light_position - vertex_position_eye;
	vec3 v2f_dir_from_view = -vertex_position_eye;
	vec3 v2f_normal = mat_normals_to_view * vertex_normal;
	surface_normal = v2f_normal;
	light_v = v2f_dir_to_light;
	view_v = v2f_dir_from_view;
